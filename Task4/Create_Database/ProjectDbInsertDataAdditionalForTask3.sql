...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL B1', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Paris'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL B3', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Instructor'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL B4', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Johan'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL C1', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Johanna'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL C2', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Sara'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL C3', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Linnea'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL D1', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Steve'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL D2', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Paris'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL D3', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Paris'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL E1', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Sara'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL E2', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Johanna'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL E3', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Steve'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL N1', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Johan'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL N2', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Paris'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL N3', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Paris'));
...
INSERT INTO lesson(location, skill_level_id, instrument_type_id, person_id)
VALUES('SAL N4', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_type_id FROM instrument_type WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Paris'));
