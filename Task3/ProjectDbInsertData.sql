...
VALUES('SAL B2', (SELECT skill_level_id FROM skill_level WHERE level = 'intermediate'), (SELECT instrument_id FROM instrument WHERE type_of_instrument = 'Piano'), (SELECT person_id FROM person WHERE first_name = 'Paris'));
